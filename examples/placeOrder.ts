...
// port: 7496
    ...
    console.log('%s %s%d', chalk.cyan('[nextValidId]'), chalk.bold('orderId='), orderId);
}).on('openOrder', function (orderId, contract, order, orderState) {
    console.log('%s %s%d %s%s %s%s %s%s', chalk.cyan('[openOrder]'), chalk.bold('orderId='), orderId, chalk.bold('contract='), JSON.stringify(contract), chalk.bold('order='), JSON.stringify(order), chalk.bold('orderState='), JSON.stringify(orderState));
    ...
    console.log('%s %s%d %s%s %s%d %s%d %s%d %s%d %s%d %s%d %s%d %s%s', chalk.cyan('[orderStatus]'), chalk.bold('id='), id, chalk.bold('status='), status, chalk.bold('filled='), filled, chalk.bold('remaining='), remaining, chalk.bold('avgFillPrice='), avgFillPrice, chalk.bold('permId='), permId, chalk.bold('parentId='), parentId, chalk.bold('lastFillPrice='), lastFillPrice, chalk.bold('clientId='), clientId, chalk.bold('whyHeld='), whyHeld);
});
