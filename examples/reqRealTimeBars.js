...
// port: 7496
    ...
    console.log('%s %s%d %s%d %s%d %s%d %s%d %s%d %s%d %s%d %s%d', chalk.cyan('[realtimeBar]'), chalk.bold('reqId='), reqId, chalk.bold('time='), time, chalk.bold('open='), open, chalk.bold('high='), high, chalk.bold('low='), low, chalk.bold('close='), close, chalk.bold('volume='), volume, chalk.bold('wap='), wap, chalk.bold('count='), count);
});
ib.connect();
// Forex
