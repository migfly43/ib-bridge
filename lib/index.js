...
var IB = /** @class */ (function (_super) {
    ...
    function IB(options) {
        ...
        _this.contract = require('./contract');
        _this.order = order;
        _this.util = require('./util');
        ;
    ...
    ;
    IB.prototype.exerciseOptions = function (tickerId, contract, exerciseAction, exerciseQuantity, account, override) {
        assert(_.isNumber(tickerId), '"tickerId" must be an integer - ' + tickerId);
    ...
    ;
    IB.prototype.reqHistoricalData = function (tickerId, contract, endDateTime, durationStr, barSizeSetting, whatToShow, useRTH, formatDate, keepUpToDate) {
        assert(_.isNumber(tickerId), '"tickerId" must be an integer - ' + tickerId);
        assert(_.isPlainObject(contract), '"contract" must be a plain object - ' + contract);
    ...
    ;
    IB.prototype.debugMsg = function (msg) {
