export var VERSION = "twsapi_macunix.970.01";

export var DEFAULT_HOST = "127.0.0.1";
export var DEFAULT_PORT = 7496;
export var DEFAULT_CLIENT_ID = 0;
export var MAX_REQ_PER_SECOND = 40;

export var CLIENT_VERSION = 62;
export var SERVER_VERSION = 76;
...
export var BAG_SEC_TYPE = "BAG";

// FA msg data types
export var FA_DATA_TYPE = {
  GROUPS: 1,
  PROFILES: 2,
  ALIASES: 3
};
