...
export declare var DEFAULT_CLIENT_ID: number;
export declare var MAX_REQ_PER_SECOND: number;
export declare var CLIENT_VERSION: number;
export declare var SERVER_VERSION: number;
export declare var INCOMING: {
    TICK_PRICE: number;
    TICK_SIZE: number;
    ORDER_STATUS: number;
    ERR_MSG: number;
...
export declare var MIN_SERVER_VER: {
    REAL_TIME_BARS: number;
    SCALE_ORDERS: number;
...
export declare var BAG_SEC_TYPE: string;
export declare var FA_DATA_TYPE: {
    GROUPS: number;
    PROFILES: number;
    ALIASES: number;
};
export declare var LOG_LEVEL: {
    SYSTEM: number;
    ERROR: number;
    WARN: number;
    INFO: number;
...
export declare var EXERCISE_ACTION: {
    EXERCISE: number;
    LAPSE: number;
};
